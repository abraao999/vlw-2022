...
export function FeedbackSuccessStep({ onFeedbackRestartRequest }:FeedbackTypeContentProps) {
  return (
    <>
      <head>
        <CloseButton />
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <span className="text-xl mt-8">Agradecemos pelo feedback</span>
        <button
          type="button"
          onClick={onFeedbackRestartRequest}
          className="py-2 px-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:border-b-brand-500 focus:ring-brand-500 focus:ring-1 focus:outline-none"
        >
          Quero enviar outro
        </button>
      </div>
